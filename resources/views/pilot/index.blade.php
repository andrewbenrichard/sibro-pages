...
<body>
    <div id="__next">
                        ...
                        <div class="col-xxl-8 col-xl-7">
                            <div class="text-center">
                                <div class="banner-title_wrapper">
                                    <h2 class="dbanner-title dbanner2-title">🖐Hi, Welcome to Resellers Guide?</h2>
                                    <p class="banner-subtitle banner2-subtitle">Find video guides and contents to help
                                        you sell Faster, Better and Smarter.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-12 ">
            <div class="du__docs pl-5 pr-5 pb-100">
                <div class="du__docs-right">
                    <div class="du__docs-right-title pb-35">
                        <h2 class="font-bold">Video Guides</h2>
                    </div>
                </div>
                <div class="du-single-featurs bg-[#EFEDF5] rounded-xl p-2">
                    <div class="list__widgets-wrapper">
                        <div class="list__widgets pt-1 px-2">
                            <div class="list__widgets-title ">
                                <h3>How to Add product to your store</h3>
                            </div>
                        </div>
                    </div>
                    <div class="youtube__video py-3 px-2"><iframe
                            src="https://www.youtube-nocookie.com/embed/_Nv0HMbjCRI"></iframe></div>
                </div>
            </div>
        </div>
    </div>
    <script id="__NEXT_DATA__" type="application/json">
        {"props":{"pageProps":{}},"page":"/","query":{},"buildId":"fX0HIuSjLN0OMn1TaB7vx","nextExport":true,"autoExport":true,"isFallback":false,"scriptLoader":[]}
    </script>
</body>
